...
DHT sensor2(D5, DHT11); // Change the pin D3 to suit your needs and sensor type to match yours e.g. DHT11, or DHT 21 or DHT22

// Now declare the variables that will hold the sensor readings
float sensor1_temp,
      sensor2_temp; // Add more if required

float sensor1_humi,
      sensor2_humi; // Add more if required
